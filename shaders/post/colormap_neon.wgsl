// Post-processing: neon rainbow colormap.
// Maps brightness to a cycling rainbow palette.
...
fn fs_main(in: VertexOutput) -> @location(0) vec4<f32> {
    ...
    let mapped = vec3<f32>(r, g, b);

    // Blend: more colormap at lower brightness, keep bright areas hot
